...
function getInfoBasedOnScore() {
    if (totalScore() < 70) {
        var score_info = "Que pena! Você ainda precisa melhorar seus hábitos e entender a importância de preservar o meio ambiente.";
    } else if (totalScore() >= 70) {
        var score_info = "Parabéns! Você possui grande preocupação com o meio ambiente e sustentabilidade!"
    }
